...
Route::get('/order_page', 	['as'=>'order_page', 	'uses'=>'MainController@order_page'	]); // order_page
...
Route::post('/admin_logout', 	['as'=>'admin_logout', 	'uses'=>'MainController@admin_logout'	]); // redirect
...
Route::get('/cabinet',			['as'=>'cabinet', 		'uses'=>'MainController@cabinet'		]); // cabinet
Route::post('/registration',	['as'=>'registration', 	'uses'=>'MainController@registration'	]); // redirect
Route::post('/forgot_pass',		['as'=>'forgot_pass', 	'uses'=>'MainController@forgot_pass'	]); // redirect
Route::post('/feedback',		['as'=>'feedback', 		'uses'=>'MainController@feedback'		]); // redirect
Route::post('/order',			['as'=>'order', 		'uses'=>'MainController@order'			]); // redirect
